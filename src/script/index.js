window.onload = function () {
  ...
  setInterval(() => {
    const imagens = [
      '/public/assents/img/informacao1.png',
      '/public/assents/img/informacao2.png',
      '/public/assents/img/informacao3.png',
      '/public/assents/img/informacao4.png'
    ];
...
setTimeout(() => {
    window.location.href = '/src/pages/paginainicial.html'; // <-- Link do destino
  }, 40000);
